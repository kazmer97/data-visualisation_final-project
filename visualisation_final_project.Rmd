...
knitr::opts_chunk$set(
  echo = FALSE,fig.align = 'left', message = FALSE, echo = FALSE, results = FALSE, warning = FALSE
)
```
...
```{r space_race1, fig.height= 5, fig.width= 11}
...
```{r space_race, fig.height= 5, fig.width= 11}
...
# Slide 4
```{r space_race success, fig.height= 5, fig.width= 11}
age <- astronauts %>% 
