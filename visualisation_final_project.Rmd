...
space_race_dates
```
```{r space race success ,fig.align='center', fig.height= 5, fig.width= 11}
...
```{r space race key dates, fig.align='center', fig.height= 5, fig.width= 11}
...
test <- launches %>% 
  ...
  annotate("rect", xmin = 1957, xmax = 1969, ymin = 0, ymax = 150,
           alpha = 0.3, fill = "skyblue")+
  ...
  annotation_custom(g, xmin=1955, xmax=195, ymin=57, ymax=80)+
  ...
  annotate("segment", x = 1968, y = 0, xend = 1968, yend = 120 , color = "blue")+
  annotate("text", x = 1968, y = 125, label = "Apollo 8 first human crewed spacecraft to reach the moon, orbit, and return to earth", color = "blue", hjust = .8)+
  
  annotate("segment", x = 1969, y = 0, xend = 1969, yend = 130 , color = "blue")+
  annotate("text", x = 1969, y = 135, label = "First men to walk on the moon - American victory", color = "blue", hjust = 1)+
